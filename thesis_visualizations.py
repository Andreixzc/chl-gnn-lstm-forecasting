"""
Thesis Visualizations - Essential Plots for Chlorophyll Prediction
Creates publication-quality figures for thesis presentation
"""
...
class ThesisVisualizations:
    """Generate professional visualizations for thesis"""
    
    def __init__(self, output_dir='thesis_figures'):
    ...
    def plot_predicted_vs_actual(self, y_true, y_pred, metrics, save_name='predicted_vs_actual.png'):
        ...
        Args:
            ...
            metrics: Dictionary with R², RMSE, etc.
        ...
        # Labels and title
        ax.set_xlabel('Actual Chlorophyll-a (mg/m³)', fontweight='bold')
        ax.set_ylabel('Predicted Chlorophyll-a (mg/m³)', fontweight='bold')
        ax.set_title('Model Performance: Predicted vs Actual', 
                    fontweight='bold', fontsize=14)
        
        # Add metrics text box
        textstr = f"R² = {metrics['r2']:.4f}\n"
        textstr += f"RMSE = {metrics['rmse']:.4f} mg/m³\n"
        textstr += f"MAE = {metrics['mae']:.4f} mg/m³\n"
    ...
    def plot_residuals(self, y_true, y_pred, save_name='residual_analysis.png'):
        ...
        ax1.set_xlabel('Predicted Chlorophyll-a (mg/m³)', fontweight='bold')
        ...
        ax2.set_xlabel('Residuals (mg/m³)', fontweight='bold')
    ...
    def plot_forecast_horizon_performance(self, per_timestep_metrics, 
        ...
        ax1.set_title('R² by Forecast Step', fontweight='bold')
        ax1.grid(True, alpha=0.3)
        ax1.set_ylim([0, 1])
        ...
        ax2.set_ylabel('RMSE (mg/m³)', fontweight='bold')
        ...
        ax3.set_ylabel('MAE (mg/m³)', fontweight='bold')
    ...
    def create_summary_figure(self, y_true, y_pred, metrics, per_timestep_metrics,
        ...
        """
        Create comprehensive multi-panel summary figure for thesis
        """
        ...
        ax1.set_xlabel('Actual (mg/m³)', fontweight='bold')
        ax1.set_ylabel('Predicted (mg/m³)', fontweight='bold')
        ...
        ax2.set_xlabel('Predicted (mg/m³)', fontweight='bold')
        ...
        ax3.set_xlabel('Residuals (mg/m³)', fontweight='bold')
        ax3.set_ylabel('Frequency', fontweight='bold')
        ax3.set_title('(C) Error Distribution', fontweight='bold')
        ax3.grid(True, alpha=0.3, axis='y')
        
        # 4. Forecast horizon - R² (bottom-left)
        ...
        ax4.set_title('(D) R² by Forecast Horizon', fontweight='bold')
        ...
        ax5.set_ylabel('RMSE (mg/m³)', fontweight='bold')
        ...
        table_data = [
            ['Metric', 'Value'],
            ['R²', f"{metrics['r2']:.4f}"],
            ['RMSE', f"{metrics['rmse']:.4f} mg/m³"],
            ['MAE', f"{metrics['mae']:.4f} mg/m³"],
            ['MAPE', f"{metrics['mape']:.2f}%"],
            ['Bias', f"{metrics['bias']:.4f} mg/m³"],
